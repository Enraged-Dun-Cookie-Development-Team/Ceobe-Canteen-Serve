...
pub mod all_available {
    pub use super::models::model_resource::ResourceAllAvailable as Model;

    pub use super::checkers::resource_all_available::{
...
pub mod countdown {
    pub use super::checkers::countdown::{
        CountdownCheck as Checked, CountdownChecker as Checker,
        CountdownUncheck as Uncheck,
    };
    pub use super::models::model_resource::Countdown as Model;
}
...
impl<'c, C: GetDatabaseConnect> SqlCeobeOperation<'c, C> {
    pub fn resource(&'c mut self) -> Operate<'c, C> {
        self.child()
    }
}
