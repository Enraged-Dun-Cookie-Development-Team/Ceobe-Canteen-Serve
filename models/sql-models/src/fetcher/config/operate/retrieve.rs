...
use sea_orm::{ConnectionTrait, DbErr, EntityTrait, QueryFilter, ColumnTrait, Condition};
use smallvec::SmallVec;
use sql_connection::database_traits::get_connect::GetDatabaseConnect;
use tap::TapFallible;
use tracing::{instrument, info, Span};

use crate::fetcher::config::{models::model_config::{self, Model}, checkers::config_data::FetcherConfig};
...
impl FetcherConfigSqlOperate {
    ...
    {
        info!(
            fetcherConfig.platform = platform,
        );
        ...
        D::Connect<'db>: ConnectionTrait,
    {
        ...
        for platform in platforms {
            condition = condition.add(model_config::Column::Platform.eq(platform));
        }
